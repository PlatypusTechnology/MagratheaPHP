...
</span><span id="4" class="l"><a href="#4"> 4 </a><span class="php-keyword1">class</span> MagratheaAdmin { 
</span><span id="5" class="l"><a href="#5"> 5 </a>
</span><span id="6" class="l"><a href="#6"> 6 </a>    <span class="php-keyword1">public</span> <span class="php-keyword1">function</span> Load(){
</span><span id="7" class="l"><a href="#7"> 7 </a>        <span class="php-var">$dir</span> = __DIR__.<span class="php-quote">&quot;/Magrathea_admin/&quot;</span>;
</span><span id="8" class="l"><a href="#8"> 8 </a>
</span><span id="9" class="l"><a href="#9"> 9 </a>        <span class="php-var">$page</span> = @<span class="php-var">$_GET</span>[<span class="php-quote">&quot;page&quot;</span>];
</span><span id="10" class="l"><a href="#10">10 </a>        <span class="php-keyword1">if</span>(<span class="php-keyword1">empty</span>(<span class="php-var">$page</span>)) <span class="php-var">$page</span> = <span class="php-quote">&quot;index.php&quot;</span>;
</span><span id="11" class="l"><a href="#11">11 </a>
</span><span id="12" class="l"><a href="#12">12 </a>        <span class="php-keyword1">include</span> (<span class="php-var">$dir</span>.<span class="php-var">$page</span>);
...
</span><span id="18" class="l"><a href="#18">18 </a><span class="xlang">?&gt;</span></span></code></pre>
	</div>
