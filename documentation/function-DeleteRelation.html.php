	...
	<div id="menu">
		...
		<div id="elements">
			...
			<ul>
				...
				<li class="active"><a href="function-DeleteRelation.html.php">DeleteRelation</a></li>
...
<div id="content" class="function">
	...
	<div class="alert alert-info">
		...
		<b>Located at</b>
		<a href="source-function-DeleteRelation.html.php#29-71" title="Go to source code">
			Magrathea_admin/delete_relation.php
		</a><br>
	</div>
	...
	<tr id="$arr_relation">
		...
		<td class="value"><code><var>&amp; $arr_relation</var></code></td>
		<td></td>
	</tr>
	<tr id="$relation_name">
		<td class="name"><code></code></td>
		<td class="value"><code><var>$relation_name</var></code></td>
		<td></td>
	</tr>
	<tr id="$is_mirror">
		<td class="name"><code></code></td>
		<td class="value"><code><var>$is_mirror</var> = <span class="php-keyword1">false</span></code></td>
		<td></td>
	</tr>
	</table>
