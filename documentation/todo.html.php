...
<div id="content">
	<h1>Todo</h1>
		...
		<table class="summary table table-bordered table-striped" id="methods">
				<tr>
					<td class="name"><a href="class-Magdb_.html.php">Magdb_</a></td>
					<td class="name"><code><a href="class-Magdb_.html.php#_QueryTransaction">QueryTransaction()</a></code></td>
					<td>
				...
				<tr>
					<td class="name"><a href="class-Magdb_.html.php">Magdb_</a></td>
					<td class="name"><code><a href="class-Magdb_.html.php#_PrepareAndExecute">PrepareAndExecute()</a></code></td>
					<td>
							validates types and avoids injection. Does it?
					</td>
				</tr>
				<tr>
					<td class="name"><a href="class-MagratheaDatabase.html.php">MagratheaDatabase</a></td>
					<td class="name"><code><a href="class-MagratheaDatabase.html.php#_QueryTransaction">QueryTransaction()</a></code></td>
					<td>
							confirms if this is working properly
					</td>
				</tr>
				<tr>
					<td class="name"><a href="class-MagratheaDatabase.html.php">MagratheaDatabase</a></td>
					<td class="name"><code><a href="class-MagratheaDatabase.html.php#_PrepareAndExecute">PrepareAndExecute()</a></code></td>
					<td>
							validates types and avoids injection. Does it?
					</td>
				</tr>
		...
		<h2>Functions summary</h2>
			<table class="summary table table-bordered table-striped" id="functions">
				<tr>
					<td class="name"><code><a href="function-Debug.html.php">Debug</a></code></td>
					<td>
							debug_backtrace
					</td>
				</tr>
