	...
	<div id="menu">
		...
		<div id="elements">
			...
			<ul>
				...
				<li class="active"><a href="class-MagratheaServer.html.php">MagratheaServer</a></li>
...
<div id="content" class="class">
	<h1>Class MagratheaServer</h1>


	<div class="description">
	<p>Creates a server using Magrathea Tools to respond Json files</p>
...
<p>*</p>
	...
	<div class="alert alert-info">
			...
			<b>Located at</b> <a href="source-class-MagratheaServer.html.php#4-61" title="Go to source code">MagratheaServer.php</a>
		<br>
	</div>
		...
		<tr data-order="MagratheaServer" id="_MagratheaServer">
			...
			<td class="name"><div>
			<a class="anchor" href="#_MagratheaServer">#</a>
			<code><a href="source-class-MagratheaServer.html.php#11-16" title="Go to source code">MagratheaServer</a>( )</code>
		...
		<tr data-order="Start" id="_Start">
			...
			<code><a href="source-class-MagratheaServer.html.php#18-28" title="Go to source code">Start</a>( )</code>
		...
		<tr data-order="Json" id="_Json">
			...
			<code><a href="source-class-MagratheaServer.html.php#30-33" title="Go to source code">Json</a>( <span> <var>$response</var></span> )</code>
		...
		<tr data-order="Wsdl" id="_Wsdl">
			...
			<td class="name"><div>
			<a class="anchor" href="#_Wsdl">#</a>
			<code><a href="source-class-MagratheaServer.html.php#35-47" title="Go to source code">Wsdl</a>( )</code>
