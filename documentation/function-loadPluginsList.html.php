	...
	<div id="menu">
		...
		<div id="elements">
			...
			<ul>
				...
				<li class="active"><a href="function-loadPluginsList.html.php">loadPluginsList</a></li>
...
<div id="content" class="function">
	<h1>Function loadPluginsList</h1>
	...
	<div class="alert alert-info">
		...
		<b>Located at</b>
		<a href="source-function-loadPluginsList.html.php#5-24" title="Go to source code">
			Magrathea_admin/load_plugins.php
		</a><br>
	</div>
	...
	<tr id="$installed">
		...
		<td class="value"><code><var>$installed</var> = <span class="php-keyword1">false</span></code></td>
		<td></td>
	</tr>
	</table>
