...
<div id="content" class="class">
	<h1>Class PhpClosure</h1>


	<div class="description">
	<p>PHP wrapper for the Google Closure JS Compiler web service.</p>

<p>Handles caching and recompilation of sources.  A recompilation will occur
whenever a source file, or the script calling the compiler, changes.</p>

<p>The class will handle the Last-Modified and 304 redirects for you, but if
you should set Cache-Control headers appropriate for your needs.</p>

<p>Example usage:</p>

<p>include("php-closure.php");</p>

<p>$c = new PhpClosure();
$c->add("my-app.js") ->add("popup.js") ->advancedMode() ->useClosureLibrary() ->cacheDir("/tmp/js-cache/") ->write();</p>

<p>See http://code.google.com/closure/compiler/docs/api-ref.html for more
details on the compiler options.</p>
	</div>
	...
	<div class="alert alert-info">
		...
		<tr data-order="PhpClosure" id="_PhpClosure">
...
concatenated in the order they are added.</p>
			</div>
...
concatenated in the order they are added.</p>
		...
		<tr data-order="cacheDir" id="_cacheDir">
...
for every request (NOTE: this will hit ratelimits pretty fast!)</p>
			</div>
...
for every request (NOTE: this will hit ratelimits pretty fast!)</p>
		...
		<tr data-order="useClosureLibrary" id="_useClosureLibrary">
...
resolved and the library code made available.</p>
			</div>
...
resolved and the library code made available.</p>
		...
		<tr data-order="useCodeUrl" id="_useCodeUrl">
...
<p>By default PHP-Closure posts the scripts to the compiler service, however,
this is subject to a 200000-byte size limit for the whole post request.</p>

<p>Using code_url tells the compiler service the URLs of the scripts to
fetch.  The file paths added in add() must therefore be relative to this
URL.</p>

<p>Example usage:</p>

<p>$c->add("js/my-app.js") ->add("js/popup.js") ->useCodeUrl('http://www.example.com/app/') ->cacheDir("/tmp/js-cache/") ->write();</p>

<p>This assumes your PHP script is in a directory /app/ and that the JS is in
/app/js/ and accessible via HTTP.</p>
		...
		<tr data-order="hideDebugInfo" id="_hideDebugInfo">
...
By default statistics, errors and warnings are logged to the console.</p>
			</div>
...
By default statistics, errors and warnings are logged to the console.</p>
		...
		<tr data-order="whitespaceOnly" id="_whitespaceOnly">
		...
		<tr data-order="simpleMode" id="_simpleMode">
		...
		<tr data-order="advancedMode" id="_advancedMode">
		...
		<tr data-order="getModeFromUrl" id="_getModeFromUrl">
...
'w', 's' or 'a'.</p>
		...
		<tr data-order="defaultWarnings" id="_defaultWarnings">
		...
		<tr data-order="verbose" id="_verbose">
...
invoking a recompile, if necessary.</p>
			</div>
...
invoking a recompile, if necessary.</p>
		...
		<tr data-order="_isRecompileNeeded" id="__isRecompileNeeded">
		...
		<tr data-order="_compile" id="__compile">
		...
		<tr data-order="_printWarnings" id="__printWarnings">
		...
		<tr data-order="_getCacheFileName" id="__getCacheFileName">
		...
		<tr data-order="_getHash" id="__getHash">
		...
		<tr data-order="_getParams" id="__getParams">
		...
		<tr data-order="_getParamList" id="__getParamList">
		...
		<tr data-order="_readSources" id="__readSources">
		...
		<tr data-order="_makeRequest" id="__makeRequest">
		...
		<tr data-order="_unchunk" id="__unchunk">
		...
		<tr data-order="_parseXml" id="__parseXml">
		...
		<tr data-order="_parseXmlHelper" id="__parseXmlHelper">
		...
		<tr data-order="_srcs" id="$_srcs">
			...
			<td class="value">
				<div>
					<a href="#$_srcs" class="anchor">#</a>
					<code><span class="php-keyword1">array</span>()</code>
				</div>
			</td>
		</tr>
		<tr data-order="_mode" id="$_mode">
			<td class="attributes"><code>
				public  
				string
			</code></td>
			...
			<td class="value">
				<div>
					<a href="#$_mode" class="anchor">#</a>
					<code><span class="php-quote">&quot;WHITESPACE_ONLY&quot;</span></code>
				</div>
			</td>
		</tr>
		<tr data-order="_warning_level" id="$_warning_level">
			<td class="attributes"><code>
				public  
				string
			</code></td>
			...
			<td class="value">
				<div>
					<a href="#$_warning_level" class="anchor">#</a>
					<code><span class="php-quote">&quot;DEFAULT&quot;</span></code>
				</div>
			</td>
		</tr>
		<tr data-order="_use_closure_library" id="$_use_closure_library">
			<td class="attributes"><code>
				public  
				boolean
			</code></td>
			...
			<td class="value">
				<div>
					<a href="#$_use_closure_library" class="anchor">#</a>
					<code><span class="php-keyword1">false</span></code>
				</div>
			</td>
		</tr>
		<tr data-order="_pretty_print" id="$_pretty_print">
			<td class="attributes"><code>
				public  
				boolean
			</code></td>
			...
			<td class="value">
				<div>
					<a href="#$_pretty_print" class="anchor">#</a>
					<code><span class="php-keyword1">false</span></code>
				</div>
			</td>
		</tr>
		<tr data-order="_debug" id="$_debug">
			<td class="attributes"><code>
				public  
				boolean
			</code></td>
			...
			<td class="value">
				<div>
					<a href="#$_debug" class="anchor">#</a>
					<code><span class="php-keyword1">true</span></code>
				</div>
			</td>
		</tr>
		<tr data-order="_cache_dir" id="$_cache_dir">
			<td class="attributes"><code>
				public  
				string
			</code></td>
			...
			<td class="value">
				<div>
					<a href="#$_cache_dir" class="anchor">#</a>
					<code><span class="php-quote">&quot;&quot;</span></code>
				</div>
			</td>
		</tr>
		<tr data-order="_code_url_prefix" id="$_code_url_prefix">
			<td class="attributes"><code>
				public  
				string
			</code></td>
			...
			<td class="value">
				<div>
					<a href="#$_code_url_prefix" class="anchor">#</a>
					<code><span class="php-quote">&quot;&quot;</span></code>
				</div>
			</td>
		</tr>
