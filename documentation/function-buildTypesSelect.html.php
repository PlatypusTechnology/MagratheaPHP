<?php include('inc/header.php'); ?>
	...
	<div id="menu">
		...
		<div id="elements">
			...
			<h3>Functions</h3>
			<ul>
				<li class="active"><a href="function-buildTypesSelect.html.php">buildTypesSelect</a></li>
...
<div id="content" class="function">
	<h1>Function buildTypesSelect</h1>
	...
	<div class="alert alert-info">
		...
		<b>Located at</b>
		<a href="source-function-buildTypesSelect.html.php#165-185" title="Go to source code">
			Magrathea_admin/load_table.php
		</a><br>
	</div>
	...
	<tr id="$fieldName">
		...
		<td class="value"><code><var>$fieldName</var></code></td>
		<td></td>
	</tr>
	<tr id="$selected">
		<td class="name"><code></code></td>
		<td class="value"><code><var>$selected</var></code></td>
		<td></td>
	</tr>
	</table>
