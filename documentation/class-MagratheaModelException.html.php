	...
	<div id="menu">
		...
		<div id="elements">
			...
			<ul>
				...
				<li class="active"><a href="class-MagratheaModelException.html">MagratheaModelException</a></li>
...
<div id="content" class="class">
	<h1>Class MagratheaModelException</h1>
...
Exception
		...
		<dd style="padding-left:30px">
			...
			<a href="class-MagratheaException.html"><span>MagratheaException</span></a>
		...
		<dd style="padding-left:60px">
			<img src="resources/inherit.png" alt="Extended by">
<b><span>MagratheaModelException</span></b>			
	...
	<div class="alert alert-info">
			...
			<b>Located at</b> <a href="source-class-MagratheaModelException.html#51-55" title="Go to source code">Exceptions.class.php</a>
		<br>
	</div>
		...
		<tr data-order="__construct" id="___construct">
			...
			<code><a href="source-class-MagratheaModelException.html#52-54" title="Go to source code">__construct</a>( <span> <var>$message</var> = <span class="php-quote">&quot;Error in Magrathea Model&quot;</span></span>, <span> <var>$code</var> = <span class="php-num">0</span></span>, <span>Exception <var>$previous</var> = <span class="php-keyword1">null</span></span> )</code>
			...
			<div class="description detailed hidden">
					...
					<h4>Overrides</h4>
					<div class="list"><code><a href="class-MagratheaException.html#___construct">MagratheaException::__construct</a></code></div>
		...
		<h3>Methods inherited from <a href="class-MagratheaException.html#methods">MagratheaException</a></h3>
		<p class="elementList">
			<code><a href="class-MagratheaException.html#___toString">__toString()</a></code>, 
			<code><a href="class-MagratheaException.html#_display">display()</a></code>
		</p>
		...
		<h3>Properties inherited from <a href="class-MagratheaException.html#properties">MagratheaException</a></h3>
		<p class="elementList">
			<code><a href="class-MagratheaException.html#$killerError"><var>$killerError</var></a></code>
		</p>
