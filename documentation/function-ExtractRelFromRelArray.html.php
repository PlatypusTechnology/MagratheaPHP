	...
	<div id="menu">
		...
		<div id="elements">
			...
			<ul>
				...
				<li class="active"><a href="function-ExtractRelFromRelArray.html.php">ExtractRelFromRelArray</a></li>
...
<div id="content" class="function">
	<h1>Function ExtractRelFromRelArray</h1>
	...
	<div class="alert alert-info">
		...
		<b>Located at</b>
		<a href="source-function-ExtractRelFromRelArray.html.php#91-102" title="Go to source code">
			Magrathea_admin/admin_functions.php
		</a><br>
	</div>
	...
	<tr id="$rel_arr">
		...
		<td class="value"><code><var>$rel_arr</var></code></td>
		<td></td>
	</tr>
	<tr id="$index">
		<td class="name"><code></code></td>
		<td class="value"><code><var>$index</var></code></td>
		<td></td>
	</tr>
	</table>
