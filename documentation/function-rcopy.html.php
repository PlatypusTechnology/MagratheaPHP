	...
	<div id="menu">
		...
		<div id="elements">
			...
			<ul>
				...
				<li class="active"><a href="function-rcopy.html.php">rcopy</a></li>
...
<div id="content" class="function">
	...
	<div class="alert alert-info">
		...
		<b>Located at</b>
		<a href="source-function-rcopy.html.php#23-32" title="Go to source code">
			Magrathea_admin/plugin_install.php
		</a><br>
	</div>
	...
	<tr id="$src">
		...
		<td class="value"><code><var>$src</var></code></td>
		<td></td>
	</tr>
	<tr id="$dst">
		<td class="name"><code></code></td>
		<td class="value"><code><var>$dst</var></code></td>
		<td></td>
	</tr>
	</table>
