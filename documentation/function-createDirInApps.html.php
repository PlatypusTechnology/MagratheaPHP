<?php include('inc/header.php'); ?>
	...
	<div id="menu">
		...
		<div id="elements">
			...
			<h3>Functions</h3>
			<ul>
				<li class="active"><a href="function-createDirInApps.html.php">createDirInApps</a></li>
...
<div id="content" class="function">
	<h1>Function createDirInApps</h1>
	...
	<div class="alert alert-info">
		...
		<b>Located at</b>
		<a href="source-function-createDirInApps.html.php#62-77" title="Go to source code">
			install_magrathea.php
		</a><br>
	</div>
	...
	<tr id="$dir_name">
		...
		<td class="value"><code><var>$dir_name</var></code></td>
		<td></td>
	</tr>
	<tr id="$writable">
		<td class="name"><code></code></td>
		<td class="value"><code><var>$writable</var> = <span class="php-keyword1">true</span></code></td>
		<td></td>
	</tr>
	</table>
