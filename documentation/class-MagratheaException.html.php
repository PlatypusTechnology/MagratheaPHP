	...
	<div id="menu">
		...
		<div id="elements">
			...
			<ul>
				...
				<li class="active"><a href="class-MagratheaException.html.php">MagratheaException</a></li>
...
<div id="content" class="class">
	<h1>Class MagratheaException</h1>
...
<b><span>MagratheaException</span></b>			
	...
	<div>
		...
		<p class="elementList">
			<code><a href="class-MagratheaConfigException.html.php">MagratheaConfigException</a></code>, 
			<code><a href="class-MagratheaControllerException.html.php">MagratheaControllerException</a></code>, 
			<code><a href="class-MagratheaDBException.html.php">MagratheaDBException</a></code>, 
			<code><a href="class-MagratheaModelException.html.php">MagratheaModelException</a></code>, 
			<code><a href="class-MagratheaViewException.html.php">MagratheaViewException</a></code>
		</p>
	</div>
	...
	<div class="alert alert-info">
			...
			<b>Located at</b> <a href="source-class-MagratheaException.html.php#21-36" title="Go to source code">Exceptions.class.php</a>
		<br>
	</div>
		...
		<tr data-order="__construct" id="___construct">
			...
			<code><a href="source-class-MagratheaException.html.php#22-24" title="Go to source code">__construct</a>( <span> <var>$message</var> = <span class="php-quote">&quot;Magrathea has failed... =(&quot;</span></span>, <span> <var>$code</var> = <span class="php-num">0</span></span>, <span>Exception <var>$previous</var> = <span class="php-keyword1">null</span></span> )</code>
		...
		<tr data-order="__toString" id="___toString">
			...
			<code><a href="source-class-MagratheaException.html.php#28-30" title="Go to source code">__toString</a>( )</code>
		...
		<tr data-order="display" id="_display">
			...
			<code><a href="source-class-MagratheaException.html.php#32-35" title="Go to source code">display</a>( )</code>
		...
		<tr data-order="killerError" id="$killerError">
			<td class="attributes"><code>
				public  
				boolean
			</code></td>
			...
			<td class="name">
					<a href="source-class-MagratheaException.html.php#26" title="Go to source code"><var>$killerError</var></a>
			...
			<td class="value">
				<div>
					<a href="#$killerError" class="anchor">#</a>
