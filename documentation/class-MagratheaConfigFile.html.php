	...
	<div id="menu">
		...
		<div id="elements">
			...
			<ul>
				...
				<li class="active"><a href="class-MagratheaConfigFile.html">MagratheaConfigFile</a></li>
...
<div id="content" class="class">
	<h1>Class MagratheaConfigFile</h1>


	<div class="description">
	<p>Magrathea Config loads and saves information in config files.</p>
	</div>
	...
	<div class="alert alert-info">
			...
			<b>Located at</b> <a href="source-class-MagratheaConfigFile.html#119-267" title="Go to source code">Config.class.php</a>
		<br>
	</div>
		...
		<tr data-order="__construct" id="___construct">
			...
			<code><a href="source-class-MagratheaConfigFile.html#128-130" title="Go to source code">__construct</a>( )</code>
		...
		<tr data-order="setPath" id="_setPath">
			...
			<code><a href="source-class-MagratheaConfigFile.html#132-139" title="Go to source code">setPath</a>( <span>string <var>$p</var></span> )</code>
		...
		<tr data-order="setConfig" id="_setConfig">
			...
			<code><a href="source-class-MagratheaConfigFile.html#140-147" title="Go to source code">setConfig</a>( <span>array <var>$c</var></span> )</code>
		...
		<tr data-order="setFile" id="_setFile">
			...
			<code><a href="source-class-MagratheaConfigFile.html#148-155" title="Go to source code">setFile</a>( <span>string <var>$filePath</var></span> )</code>
		...
		<tr data-order="createFileIfNotExists" id="_createFileIfNotExists">
			...
			<code><a href="source-class-MagratheaConfigFile.html#164-173" title="Go to source code">createFileIfNotExists</a>( )</code>
			...
			<div class="description detailed hidden">
				<p>Creates the configuration file if it doesn't exists. And saves it.</p>
					...
					<h4>Returns</h4>
					<div class="list">
						boolean<br>True if the file exists; Return of <code>Save()</code> function if it doesn't
					</div>
		...
		<tr data-order="getConfig" id="_getConfig">
			...
			<code><a href="source-class-MagratheaConfigFile.html#174-193" title="Go to source code">getConfig</a>( <span>string <var>$config_name</var> = <span class="php-quote">&quot;&quot;</span></span> )</code>
			...
			<div class="description detailed hidden">
				<p>Gets configuration</p>
					...
					<h4>Parameters</h4>
					<div class="list"><dl>
						<dt><var>$config_name</var></dt>
						<dd><p>Configuration to be got. If empty, returns all the configuration into the file
                                If an acceptable config name, returns its value</p></dd>
					</dl></div>

					<h4>Returns</h4>
					<div class="list">
						string/int/array<br>If <code>$config_name</code> is empty, returns all the configuration. Otherwise,
					</div>
		...
		<tr data-order="getConfigSection" id="_getConfigSection">
			...
			<code><a href="source-class-MagratheaConfigFile.html#194-209" title="Go to source code">getConfigSection</a>( <span>string <var>$section_name</var></span> )</code>
			...
			<div class="description detailed hidden">
				<p>Gets a full config section</p>
					...
					<h4>Parameters</h4>
					<div class="list"><dl>
						<dt><var>$section_name</var></dt>
						<dd>Name of the section to be shown</dd>
					</dl></div>

					<h4>Returns</h4>
					<div class="list">
						array<br>All the values of the given section
					</div>
		...
		<tr data-order="Save" id="_Save">
			...
			<code><a href="source-class-MagratheaConfigFile.html#210-262" title="Go to source code">Save</a>( <span>boolean <var>$save_sections</var> = <span class="php-keyword1">true</span></span> )</code>
			...
			<div class="description detailed hidden">
				<p>Saves the config file</p>
					...
					<h4>Parameters</h4>
					<div class="list"><dl>
						<dt><var>$save_sections</var></dt>
						<dd><p>A flag indicating if the sections should be saved also.
                                        Default: <code>true</code></p></dd>
					</dl></div>

					<h4>Returns</h4>
					<div class="list">
						boolean<br>True if the saved succesfully. False if got any error in the process
					</div>
