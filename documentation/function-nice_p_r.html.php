	...
	<div id="menu">
		...
		<div id="elements">
			...
			<ul>
				...
				<li class="active"><a href="function-nice_p_r.html.php">nice_p_r</a></li>
...
<div id="content" class="function">
	...
	<div class="alert alert-info">
		...
		<b>Located at</b>
		<a href="source-function-nice_p_r.html.php#26-40" title="Go to source code">
			Functions.php
		</a><br>
	</div>
	...
	<tr id="$debugme">
		...
		<td class="value"><code><var>$debugme</var></code></td>
		<td></td>
	</tr>
	<tr id="$prev_char">
		<td class="name"><code></code></td>
		<td class="value"><code><var>$prev_char</var> = <span class="php-quote">&quot;&quot;</span></code></td>
		<td></td>
	</tr>
	</table>
