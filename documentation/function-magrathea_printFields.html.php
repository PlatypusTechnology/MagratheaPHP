	...
	<div id="menu">
		...
		<div id="elements">
			...
			<ul>
				...
				<li class="active"><a href="function-magrathea_printFields.html">magrathea_printFields</a></li>
...
<div id="content" class="function">
	<h1>Function magrathea_printFields</h1>
	...
	<div class="alert alert-info">
		...
		<b>Located at</b>
		<a href="source-function-magrathea_printFields.html#42-55" title="Go to source code">
			Functions.php
		</a><br>
	</div>
	...
	<tr id="$fields_arr">
		...
		<td class="value"><code><var>$fields_arr</var></code></td>
		<td></td>
	</tr>
	<tr id="$selected">
		<td class="name"><code></code></td>
		<td class="value"><code><var>$selected</var> = <span class="php-keyword1">null</span></code></td>
		<td></td>
	</tr>
	</table>
