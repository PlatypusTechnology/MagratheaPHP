...
if ($chunks < 2 && file_exists($targetDir . DIRECTORY_SEPARATOR . $fileName)) {
	...
	$fileName = $fileName_a . '_' . $count . $fileName_b . $ext;
}
...
if ($cleanupTargetDir && is_dir($targetDir) && ($dir = opendir($targetDir))) {
	...
	die('{"jsonrpc" : "2.0", "error" : {"code": 100, "message": "Failed to open temp directory: '.$filePath.'"}, "id" : "id"}');
...
if($fullFile){
	// File uploaded, let's save it in the database:
	$file = $_FILES["file"];
	$imageName = $file["name"];
