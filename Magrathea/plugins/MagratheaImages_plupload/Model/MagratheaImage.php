...
*/
	...
	public function LoadConfig(){
		...
		$this->imagesPath = $config->GetConfig("images_path");
		$this->generatedPath = $config->GetConfig("generated_path");
		$this->webImagesFolder = $config->GetConfig("web_images_folder");
		$this->webImagesGenerated = $config->GetConfig("web_images_generated");
	}
