...
ApiGen.config = {  
   ...
   "templates":{  
      "overview":{  
         "filename":"docs.php?p=index.html"
      },
      "combined":{  
         "filename":"docs.php?p=resources\/combined.js"
      },
      "elementlist":{  
         "filename":"docs.php?p=elementlist.js"
      },
      "404":{  
         "filename":"docs.php?p=404.html"
      },
      "package":{  
         "filename":"docs.php?p=package-%s.html"
      },
      "namespace":{  
         "filename":"docs.php?p=namespace-%s.html"
      },
      "class":{  
         "filename":"docs.php?p=class-%s.html"
      },
      "constant":{  
         "filename":"docs.php?p=constant-%s.html"
      },
      "function":{  
         "filename":"docs.php?p=function-%s.html"
      },
      "source":{  
         "filename":"docs.php?p=source-%s.html"
      },
      "tree":{  
         "filename":"docs.php?p=tree.html"
      },
      "deprecated":{  
         "filename":"docs.php?p=deprecated.html"
      },
      "todo":{  
         "filename":"docs.php?p=todo.html"
      },
      "sitemap":{  
         "filename":"docs.php?p=sitemap.xml"
      },
      "opensearch":{  
         "filename":"docs.php?p=opensearch.xml"
      },
      "robots":{  
         "filename":"docs.php?p=robots.txt"
     }
   }
};
...
$(window).load(function() {
	...
	$search
		.autocomplete(ApiGen.elements, {
			...
			var aFiles = autocompleteFiles[data[0]];
			var filename = ApiGen.config.templates[aFiles].filename;
			partsFileName = parts[0].replace(/\(\)/, '').replace(/[^\w]/g, '.');
			var file = filename.replace(/%s/g, partsFileName);
